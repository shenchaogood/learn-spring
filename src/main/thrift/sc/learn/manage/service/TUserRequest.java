...
public class TUserRequest implements org.apache.thrift.TBase<TUserRequest, TUserRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TUserRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TUserRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TUserRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TUserRequestTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TUserRequest.class, metaDataMap);
  }
   ...
   */
  public TUserRequest(TUserRequest other) {
  ...
  public TUserRequest deepCopy() {
    return new TUserRequest(this);
  }
  ...
  public TUserRequest setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public TUserRequest setAge(int age) {
    this.age = age;
    setAgeIsSet(true);
    return this;
  }
  ...
  public TUserRequest setBirthday(long birthday) {
    this.birthday = birthday;
    setBirthdayIsSet(true);
    return this;
  }
  ...
  public TUserRequest setRemark(java.lang.String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TUserRequest)
      return this.equals((TUserRequest)that);
    return false;
  }

  public boolean equals(TUserRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TUserRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TUserRequest(");
    boolean first = true;
  ...
  private static class TUserRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TUserRequestStandardScheme getScheme() {
      return new TUserRequestStandardScheme();
    }
  }

  private static class TUserRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TUserRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TUserRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUserRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TUserRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TUserRequestTupleScheme getScheme() {
      return new TUserRequestTupleScheme();
    }
  }

  private static class TUserRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUserRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TUserRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TUserRequest struct) throws org.apache.thrift.TException {
