...
public class ThriftIfaceTransportPool extends GenericObjectPool<ThriftIfaceTransport> {
    ...
    public ThriftIfaceTransportPool(AddressProvider addressProvider, int timeout,int maxActive, int maxIdle, int minIdle,
         ...
         */
        super(new ThriftIfaceConnectionPoolFactory(addressProvider,timeout), maxActive, GenericObjectPool.WHEN_EXHAUSTED_BLOCK,
