...
public class ThriftAsyncIfaceTransportPool extends GenericObjectPool<ThriftAsyncIfaceTransport> {
    ...
    public ThriftAsyncIfaceTransportPool(AddressProvider addressProvider, int timeout,int maxActive, int maxIdle, int minIdle,
         ...
         */
        super(new ThriftAsyncIfaceConnectionPoolFactory(addressProvider,timeout), maxActive, GenericObjectPool.WHEN_EXHAUSTED_BLOCK,
